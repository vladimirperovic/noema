...
(() => {
  ...
  const ICONS = {
    ...
    files:'<svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6M8 13h8M8 17h6"/></svg>',
    ai:'<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"/><path d="m10 8 6 4-6 4V8z"/></svg>',
    building:'<svg viewBox="0 0 24 24"><path d="M4 21V6l8-3v18M12 9h8v12M7 9h2M7 13h2M7 17h2M15 12h2M15 16h2M3 21h18"/></svg>',
